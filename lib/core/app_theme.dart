...
class AppTheme {
  ...
  static const Color secondary = Color(
    0xFFFFA726,
  ); // Cam nhạt (dùng cho hover/nhấn)
  static const Color background = Color(
    0xFFFAFAFA,
  ); // Trắng ngà (tương đương grey[50])
  static const Color surface = Colors.white; // Nền của các Thẻ (Card)
  static const Color textDark = Color(
    0xFF2D3142,
  ); // Đen ánh xanh (Sang trọng hơn đen thui)
  static const Color textLight = Color(
    0xFF9E9E9E,
  ); // Xám (dùng cho mô tả, thời gian)
  static const Color success = Color(
    0xFF4CAF50,
  ); // Xanh lá (Thông báo thành công)
  static const Color error = Color(0xFFF44336); // Đỏ (Báo lỗi)
  static final Color shimmerBase =
      Colors.grey[300]!; // Màu xám nền của khung xương
  static final Color shimmerHighlight =
      Colors.grey[100]!; // Màu xám sáng lướt qua
  ...
  static final BorderRadius radiusM = BorderRadius.circular(
    16,
  ); // Bo góc thẻ nhỏ
  static final BorderRadius radiusL = BorderRadius.circular(
    24,
  ); // Bo góc thẻ lớn/Thanh tìm kiếm
